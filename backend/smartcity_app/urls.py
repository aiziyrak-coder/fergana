...
urlpatterns = [
    ...
    path('farms/<str:pk>/', views.FarmDetailView.as_view(), name='farm-detail'),
    
    # Livestock URLs
    path('livestock/', views.LivestockListCreateView.as_view(), name='livestock-list-create'),
    path('livestock/<str:pk>/', views.LivestockDetailView.as_view(), name='livestock-detail'),
    
    # Livestock Passport URLs
    path('livestock-passports/', views.LivestockPassportListCreateView.as_view(), name='livestock-passport-list-create'),
    path('livestock-passports/<str:pk>/', views.LivestockPassportDetailView.as_view(), name='livestock-passport-detail'),
    
    # Microchip Device URLs
    path('microchips/', views.MicrochipDeviceListCreateView.as_view(), name='microchip-list-create'),
    path('microchips/<str:pk>/', views.MicrochipDeviceDetailView.as_view(), name='microchip-detail'),
    
    # Livestock Lookup (Scanner)
    path('livestock/lookup/<str:microchip_id>/', views.lookup_livestock_by_microchip, name='livestock-lookup'),
    
    # Livestock Statistics
    path('livestock/statistics/overview/', views.get_livestock_statistics, name='livestock-statistics'),
]