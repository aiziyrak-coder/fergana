...
class FarmAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'owner_name', 'farm_type', 'address', 'is_active', 'created_at']
    list_filter = ['farm_type', 'is_active', 'mfy']
    search_fields = ['name', 'owner_name', 'owner_phone', 'address']


@admin.register(Livestock)
class LivestockAdmin(admin.ModelAdmin):
    list_display = ['id', 'microchip_id', 'animal_type', 'breed', 'gender', 'health_status', 'farm', 'is_active']
    list_filter = ['animal_type', 'gender', 'health_status', 'is_active']
    search_fields = ['microchip_id', 'name', 'breed']


@admin.register(LivestockPassport)
class LivestockPassportAdmin(admin.ModelAdmin):
    list_display = ['id', 'passport_number', 'livestock', 'issue_date', 'issuing_authority']
    search_fields = ['passport_number', 'livestock__microchip_id']


@admin.register(MicrochipDevice)
class MicrochipDeviceAdmin(admin.ModelAdmin):
    list_display = ['id', 'chip_id', 'livestock', 'status', 'last_scanned', 'battery_level']
    list_filter = ['status']
    search_fields = ['chip_id']