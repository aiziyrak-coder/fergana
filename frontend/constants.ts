...
import { LayoutGrid, PieChart, Droplets, ThermometerSun, Trash, Wind, HardHat, Eye, Lightbulb, ShieldAlert, Bus as BusIcon, PhoneCall, Target, Route, TrendingUp, Bell, Calendar, Zap, Activity, FileText, Settings, Beef } from 'lucide-react';
...
export const ALL_MODULES: ModuleDefinition[] = [
    ...
    { id: 'LIVESTOCK', label: 'Chorva', icon: Beef, description: "Chorva monitoringi, fermer xo'jaliklari va microchip tizimi" },
];
